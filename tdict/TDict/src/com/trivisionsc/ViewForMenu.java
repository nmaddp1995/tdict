...
public class ViewForMenu extends View {

  // Constructor required for in-code creation
  public ViewForMenu(Context context) {
    super(context);
  }
 
  //Constructor required for inflation from resource file
  public ViewForMenu (Context context, AttributeSet attrs) {
    super(context, attrs);
  }
  
  // Constructor required for inflation from resource file
  public ViewForMenu (Context context, AttributeSet attrs, int defaultStyle) {
